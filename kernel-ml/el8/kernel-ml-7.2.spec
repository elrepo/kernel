...
%changelog
* Fri Sep 25 2026 S.Tindall <s10dal@elrepo.org> - 7.2.8-1
- Updated with the 7.2.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.2.8]
- Added: CONFIG_REGMAP_SOUNDWIRE=m
- Added: CONFIG_REGMAP_SOUNDWIRE_MBQ=m
- Added: CONFIG_SND_SOC_SDCA_CLASS_FUNCTION=m
- Added: CONFIG_SND_SOC_SDCA_CLASS=m

* Mon Sep 21 2026 S.Tindall <s10dal@elrepo.org> - 7.2.7-1
- Updated with the 7.2.7 source tarball.
...
* Wed Sep 02 2026 S.Tindall <s10dal@elrepo.org> - 7.2.3-1
- Updated with the 7.2.3 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.2.3]

* Fri Aug 28 2026 S.Tindall <s10dal@elrepo.org> - 7.2.2-1
...
- Added: CONFIG_PINCTRL_INTEL_PLATFORM=m

* Mon Aug 03 2026 S.Tindall <s10dal@elrepo.org> - 7.1.6-1
- Updated with the 7.1.6 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.6]
- Removed: CONFIG_SND_SOC_ACPI_AMD_SDCA_QUIRKS=m
- Added: CONFIG_SND_SOC_ACPI_AMD_SDCA_QUIRKS=y

* Fri Jul 24 2026 S.Tindall <s10dal@elrepo.org> - 7.1.5-1
- Updated with the 7.1.5 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.5]
- Removed: CONFIG_CRYPTO_LIB_AES_CBC_MACS=m
- Added: CONFIG_CRYPTO_LIB_AES_CBC_MACS=y
- Added: CONFIG_DRM_ACCEL_IVPU=m
- Added: CONFIG_DRM_ACCEL=y

* Sat Jul 18 2026 S.Tindall <s10dal@elrepo.org> - 7.1.4-1
- Updated with the 7.1.4 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.4]

* Sat Jul 04 2026 S.Tindall <s10dal@elrepo.org> - 7.1.3-1
...
- Removed: CONFIG_DEV_SYNC_PROBE=m

* Sat May 23 2026 S.Tindall <s10dal@elrepo.org> - 7.0.10-1
- Updated with the 7.0.10 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.0.10]
- Added: CONFIG_RTW89_8922AE=m
- Added: CONFIG_RTW89_8922A=m

* Sun May 17 2026 S.Tindall <s10dal@elrepo.org> - 7.0.9-1
...
* Mon Feb 16 2026 S.Tindall <s10dal@elrepo.org> - 6.19.2-1
...
* Mon Oct 06 2025 S.Tindall <s10dal@elrepo.org> - 6.17.1
- Updated with the 6.17.1 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.1]

* Sun Sep 28 2025 S.Tindall <s10dal@elrepo.org> - 6.17.0
- Updated with the 6.17 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17]
- Removed: CONFIG_ARCH_HAS_CRC32=y
- Removed: CONFIG_ARCH_HAS_CRC64=y
- Removed: CONFIG_ARCH_HAS_CRC_T10DIF=y
- Removed: CONFIG_ARCH_HAS_PTE_DEVMAP=y
- Removed: CONFIG_BRIDGE_EBT_BROUTE=m
- Removed: CONFIG_BRIDGE_EBT_T_FILTER=m
- Removed: CONFIG_BRIDGE_EBT_T_NAT=m
- Removed: CONFIG_BRIDGE_NF_EBTABLES_LEGACY=m
- Removed: CONFIG_CRC16=m
- Removed: CONFIG_CRC32_ARCH=y
- Removed: CONFIG_CRC32=y
- Removed: CONFIG_CRC64_ARCH=y
- Removed: CONFIG_CRC64=y
- Removed: CONFIG_CRC7=m
- Removed: CONFIG_CRC8=m
- Removed: CONFIG_CRC_CCITT=y
- Removed: CONFIG_CRC_ITU_T=m
- Removed: CONFIG_CRC_OPTIMIZATIONS=y
- Removed: CONFIG_CRC_T10DIF_ARCH=y
- Removed: CONFIG_CRC_T10DIF=y
- Removed: CONFIG_CRYPTO_ARCH_HAVE_LIB_SHA256_SIMD=y
- Removed: CONFIG_CRYPTO_ARCH_HAVE_LIB_SHA256=y
- Removed: CONFIG_CRYPTO_HASH_INFO=y
- Removed: CONFIG_CRYPTO_LIB_SHA256_GENERIC=y
- Removed: CONFIG_CRYPTO_SHA1_SSSE3=y
- Removed: CONFIG_CRYPTO_SHA256_X86_64=y
- Removed: CONFIG_CRYPTO_SHA512_SSSE3=m
- Removed: CONFIG_DPLL=y
- Removed: CONFIG_DRM_XE_DEVMEM_MIRROR=y
- Removed: CONFIG_FTRACE_MCOUNT_RECORD=y
- Removed: CONFIG_HAVE_ARCH_STACKLEAK=y
- Removed: CONFIG_HAVE_FTRACE_MCOUNT_RECORD=y
- Removed: CONFIG_IDEAPAD_LAPTOP=m
- Removed: CONFIG_INFINIBAND_QIB_DCA=y
- Removed: CONFIG_INFINIBAND_QIB=m
- Removed: CONFIG_IP6_NF_FILTER=m
- Removed: CONFIG_IP6_NF_IPTABLES_LEGACY=m
- Removed: CONFIG_IP6_NF_MANGLE=m
- Removed: CONFIG_IP6_NF_NAT=m
- Removed: CONFIG_IP6_NF_RAW=m
- Removed: CONFIG_IP6_NF_SECURITY=m
- Removed: CONFIG_IP6_NF_TARGET_HL=m
- Removed: CONFIG_IP6_NF_TARGET_MASQUERADE=m
- Removed: CONFIG_IP_NF_ARPFILTER=m
- Removed: CONFIG_IP_NF_ARPTABLES=m
- Removed: CONFIG_IP_NF_FILTER=m
- Removed: CONFIG_IP_NF_IPTABLES_LEGACY=m
- Removed: CONFIG_IP_NF_MANGLE=m
- Removed: CONFIG_IP_NF_NAT=m
- Removed: CONFIG_IP_NF_RAW=m
- Removed: CONFIG_IP_NF_SECURITY=m
- Removed: CONFIG_IP_NF_TARGET_MASQUERADE=m
- Removed: CONFIG_IP_NF_TARGET_NETMAP=m
- Removed: CONFIG_IP_NF_TARGET_REDIRECT=m
- Removed: CONFIG_IP_NF_TARGET_TTL=m
- Removed: CONFIG_NETFILTER_XT_TARGET_NOTRACK=m
- Removed: CONFIG_NETFILTER_XT_TARGET_TRACE=m
- Removed: CONFIG_NF_CT_PROTO_DCCP=y
- Removed: CONFIG_PAGE_BLOCK_ORDER=10
- Removed: CONFIG_RTC_DRV_PCF85063=m
- Removed: CONFIG_SND_ATMEL_SOC=m
- Removed: CONFIG_SND_HDA_CODEC_CIRRUS=m
- Removed: CONFIG_SND_HDA_CODEC_CS8409=m
- Removed: CONFIG_SND_HDA_CODEC_HDMI=m
- Removed: CONFIG_SND_HDA_CODEC_REALTEK=m
- Removed: CONFIG_SND_HDA_GENERIC_LEDS=y
- Removed: CONFIG_SND_HDA_INTEL=m
- Removed: CONFIG_SND_HDA_POWER_SAVE_DEFAULT=0
- Removed: CONFIG_SND_HDA_PREALLOC_SIZE=0
- Removed: CONFIG_SND_HDA_SCODEC_COMPONENT=m
- Removed: CONFIG_SND_HDA_SCODEC_CS35L41_I2C=m
- Removed: CONFIG_SND_HDA_SCODEC_CS35L41=m
- Removed: CONFIG_SND_HDA_SCODEC_CS35L41_SPI=m
- Removed: CONFIG_SND_SOC_ADI=m
- Removed: CONFIG_SND_SOC_IMG_I2S_IN=m
- Removed: CONFIG_SND_SOC_IMG_I2S_OUT=m
- Removed: CONFIG_SND_SOC_IMG_PARALLEL_OUT=m
- Removed: CONFIG_SND_SOC_IMG_PISTACHIO_INTERNAL_DAC=m
- Removed: CONFIG_SND_SOC_IMG_SPDIF_IN=m
- Removed: CONFIG_SND_SOC_IMG_SPDIF_OUT=m
- Removed: CONFIG_SND_SOC_IMG=y
- Removed: CONFIG_SND_SOC_XILINX_AUDIO_FORMATTER=m
- Removed: CONFIG_SND_SOC_XILINX_I2S=m
- Removed: CONFIG_SND_SOC_XILINX_SPDIF=m
- Removed: CONFIG_SND_SOC_XTFPGA_I2S=m
- Removed: CONFIG_THINKPAD_ACPI_ALSA_SUPPORT=y
- Removed: CONFIG_THINKPAD_ACPI_HOTKEY_POLL=y
- Removed: CONFIG_THINKPAD_ACPI=m
- Removed: CONFIG_THINKPAD_ACPI_VIDEO=y
- Removed: CONFIG_THINKPAD_LMI=m
- Added: CONFIG_ARCH_HAS_CPU_ATTACK_VECTORS=y
- Added: CONFIG_ARCH_SUPPORTS_HUGETLBFS=y
- Added: CONFIG_CRC16=m
- Added: CONFIG_CRC32_ARCH=y
- Added: CONFIG_CRC32=y
- Added: CONFIG_CRC64_ARCH=y
- Added: CONFIG_CRC64=y
- Added: CONFIG_CRC7=m
- Added: CONFIG_CRC8=m
- Added: CONFIG_CRC_CCITT=y
- Added: CONFIG_CRC_ITU_T=m
- Added: CONFIG_CRC_OPTIMIZATIONS=y
- Added: CONFIG_CRC_T10DIF_ARCH=y
- Added: CONFIG_CRC_T10DIF=y
- Added: CONFIG_CRYPTO_HASH_INFO=y
- Added: CONFIG_CRYPTO_LIB_SHA1_ARCH=y
- Added: CONFIG_CRYPTO_LIB_SHA256_ARCH=y
- Added: CONFIG_CRYPTO_LIB_SHA512_ARCH=y
- Added: CONFIG_CRYPTO_LIB_SHA512=y
- Added: CONFIG_DPLL=y
- Added: CONFIG_DRM_DISPLAY_HDMI_CEC_NOTIFIER_HELPER=y
- Added: CONFIG_DRM_XE_PAGEMAP=y
- Added: CONFIG_EFI_SBAT_FILE=""
- Added: CONFIG_EPROBE_EVENTS=y
- Added: CONFIG_FUTEX_PRIVATE_HASH=y
- Added: CONFIG_GENERIC_IRQ_ENTRY=y
- Added: CONFIG_GENERIC_SYSCALL=y
- Added: CONFIG_GPIOLIB_LEGACY=y
- Added: CONFIG_GROUP_SCHED_BANDWIDTH=y
- Added: CONFIG_HAVE_ARCH_KSTACK_ERASE=y
- Added: CONFIG_IDEAPAD_LAPTOP=m
- Added: CONFIG_IRQ_MSI_LIB=y
- Added: CONFIG_KVM_IOAPIC=y
- Added: CONFIG_LIBIE_ADMINQ=m
- Added: CONFIG_PAGE_BLOCK_MAX_ORDER=10
- Added: CONFIG_PHY_PACKAGE=m
- Added: CONFIG_RTC_DRV_PCF85063=m
- Added: CONFIG_SND_HDA_CODEC_ALC260=m
- Added: CONFIG_SND_HDA_CODEC_ALC262=m
- Added: CONFIG_SND_HDA_CODEC_ALC268=m
- Added: CONFIG_SND_HDA_CODEC_ALC269=m
- Added: CONFIG_SND_HDA_CODEC_ALC662=m
- Added: CONFIG_SND_HDA_CODEC_ALC680=m
- Added: CONFIG_SND_HDA_CODEC_ALC861=m
- Added: CONFIG_SND_HDA_CODEC_ALC861VD=m
- Added: CONFIG_SND_HDA_CODEC_ALC880=m
- Added: CONFIG_SND_HDA_CODEC_ALC882=m
- Added: CONFIG_SND_HDA_CODEC_CIRRUS=m
- Added: CONFIG_SND_HDA_CODEC_CS420X=m
- Added: CONFIG_SND_HDA_CODEC_CS421X=m
- Added: CONFIG_SND_HDA_CODEC_CS8409=m
- Added: CONFIG_SND_HDA_CODEC_HDMI_ATI=m
- Added: CONFIG_SND_HDA_CODEC_HDMI_GENERIC=m
- Added: CONFIG_SND_HDA_CODEC_HDMI_INTEL=m
- Added: CONFIG_SND_HDA_CODEC_HDMI=m
- Added: CONFIG_SND_HDA_CODEC_HDMI_NVIDIA=m
- Added: CONFIG_SND_HDA_CODEC_HDMI_NVIDIA_MCP=m
- Added: CONFIG_SND_HDA_CODEC_HDMI_SIMPLE=m
- Added: CONFIG_SND_HDA_CODEC_HDMI_TEGRA=m
- Added: CONFIG_SND_HDA_CODEC_REALTEK_LIB=m
- Added: CONFIG_SND_HDA_CODEC_REALTEK=m
- Added: CONFIG_SND_HDA_GENERIC_LEDS=y
- Added: CONFIG_SND_HDA_INTEL=m
- Added: CONFIG_SND_HDA_POWER_SAVE_DEFAULT=0
- Added: CONFIG_SND_HDA_PREALLOC_SIZE=0
- Added: CONFIG_SND_HDA_SCODEC_COMPONENT=m
- Added: CONFIG_SND_HDA_SCODEC_CS35L41_I2C=m
- Added: CONFIG_SND_HDA_SCODEC_CS35L41=m
- Added: CONFIG_SND_HDA_SCODEC_CS35L41_SPI=m
- Added: CONFIG_SND_SOC_SDCA_HID=y
- Added: CONFIG_SND_SOC_SDCA_IRQ=y
- Added: CONFIG_SND_SOC_XILINX_AUDIO_FORMATTER=m
- Added: CONFIG_SND_SOC_XILINX_I2S=m
- Added: CONFIG_SND_SOC_XILINX_SPDIF=m
- Added: CONFIG_SND_SOC_XTFPGA_I2S=m
- Added: CONFIG_THINKPAD_ACPI_ALSA_SUPPORT=y
- Added: CONFIG_THINKPAD_ACPI_HOTKEY_POLL=y
- Added: CONFIG_THINKPAD_ACPI=m
- Added: CONFIG_THINKPAD_ACPI_VIDEO=y
- Added: CONFIG_THINKPAD_LMI=m
- Added: CONFIG_TRACEFS_AUTOMOUNT_DEPRECATED=y
- Added: CONFIG_VIDEO_CAMERA_LENS=y

* Thu Sep 25 2025 S.Tindall <s10dal@elrepo.org> - 6.16.9
- Updated with the 6.16.9 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.9]

* Fri Sep 19 2025 S.Tindall <s10dal@elrepo.org> - 6.16.8
...
* Thu Sep 11 2025 S.Tindall <s10dal@elrepo.org> - 6.16.7
- Updated with the 6.16.7 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.7]
- Added: CONFIG_MITIGATION_VMSCAPE=y

* Tue Sep 09 2025 S.Tindall <s10dal@elrepo.org> - 6.16.6
- Updated with the 6.16.6 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.6]

* Thu Sep 04 2025 S.Tindall <s10dal@elrepo.org> - 6.16.5
- Updated with the 6.16.5 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.5]

* Thu Aug 28 2025 S.Tindall <s10dal@elrepo.org> - 6.16.4
- Updated with the 6.16.4 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.4]
- Added: CONFIG_AMD_HSMP_ACPI=m
- Added: CONFIG_AMD_HSMP=m
- Added: CONFIG_AMD_HSMP_PLAT=m

* Sat Aug 23 2025 S.Tindall <s10dal@elrepo.org> - 6.16.3
- Updated with the 6.16.3 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.3]

* Wed Aug 20 2025 S.Tindall <s10dal@elrepo.org> - 6.16.2
- Updated with the 6.16.2 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.2]
- Added: CONFIG_SND_SOC_SOF_AMD_ACP63=m
- Added: CONFIG_SND_SOC_SOF_AMD_ACP70=m
- Added: CONFIG_SND_SOC_SOF_AMD_SOUNDWIRE_LINK_BASELINE=m
- Added: CONFIG_SND_SOC_SOF_AMD_SOUNDWIRE=m

* Fri Aug 15 2025 S.Tindall <s10dal@elrepo.org> - 6.16.1
- Updated with the 6.16.1 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.1]
- Added: CONFIG_HFSPLUS_FS=m
- Added: CONFIG_VHOST_ENABLE_FORK_OWNER_CONTROL=y

* Sun Jul 27 2025 S.Tindall <s10dal@elrepo.org> - 6.16.0
- Updated with the 6.16 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16]
- Removed: CONFIG_AS_SHA1_NI=y
- Removed: CONFIG_AS_SHA256_NI=y
- Removed: CONFIG_AS_TPAUSE=y
- Removed: CONFIG_BLK_MQ_PCI=y
- Removed: CONFIG_BLK_MQ_VIRTIO=y
- Removed: CONFIG_BT_HCIBTUSB_AUTO_ISOC_ALT=y
- Removed: CONFIG_CC_HAS_SANCOV_TRACE_PC=y
- Removed: CONFIG_CRYPTO_BLAKE2S_X86=y
- Removed: CONFIG_CRYPTO_CHACHA20_X86_64=m
- Removed: CONFIG_CRYPTO_FIPS_NAME="Linux Kernel Cryptographic API"
- Removed: CONFIG_CRYPTO_FIPS=y
- Removed: CONFIG_CRYPTO_LIB_CHACHA_INTERNAL=m
- Removed: CONFIG_CRYPTO_LIB_POLY1305_INTERNAL=m
- Removed: CONFIG_CRYPTO_NULL2=y
- Removed: CONFIG_CRYPTO_POLY1305=m
- Removed: CONFIG_CRYPTO_POLY1305_X86_64=m
- Removed: CONFIG_CRYPTO_SHA256_SSSE3=y
- Removed: CONFIG_CRYPTO_SIMD=y
- Removed: CONFIG_CRYPTO_SM3=m
- Removed: CONFIG_CRYPTO_TEST=m
- Removed: CONFIG_DYNAMIC_MEMORY_LAYOUT=y
- Removed: CONFIG_MDIO_DEVICE=y
- Removed: CONFIG_MDIO_DEVRES=y
- Removed: CONFIG_MTK_NET_PHYLIB=m
- Removed: CONFIG_SENSORS_OXP=m
- Removed: CONFIG_SENSORS_SBRMI=m
- Removed: CONFIG_SND_HDA_CS_DSP_CONTROLS=m
- Removed: CONFIG_TINYDRM_ST7586=m
- Removed: CONFIG_TINYDRM_ST7735R=m
- Removed: CONFIG_TSM_REPORTS=m
- Removed: CONFIG_X86_5LEVEL=y
- Added: CONFIG_ACPI_MRRM=y
- Added: CONFIG_ARCH_SUPPORTS_KEXEC_HANDOVER=y
- Added: CONFIG_ARCH_WANT_IRQS_OFF_ACTIVATE_MM=y
- Added: CONFIG_CC_HAS_MARCH_NATIVE=y
- Added: CONFIG_CRYPTO_ARCH_HAVE_LIB_SHA256_SIMD=y
- Added: CONFIG_CRYPTO_ARCH_HAVE_LIB_SHA256=y
- Added: CONFIG_CRYPTO_BLAKE2S_X86=y
- Added: CONFIG_CRYPTO_CHACHA20_X86_64=m
- Added: CONFIG_CRYPTO_KRB5ENC=m
- Added: CONFIG_CRYPTO_KRB5=m
- Added: CONFIG_CRYPTO_LIB_SHA256_GENERIC=y
- Added: CONFIG_CRYPTO_LIB_SM3=m
- Added: CONFIG_CRYPTO_POLY1305_X86_64=m
- Added: CONFIG_CRYPTO_SHA256_X86_64=y
- Added: CONFIG_DEV_SYNC_PROBE=m
- Added: CONFIG_DRM_XE_GPUSVM=y
- Added: CONFIG_FUTEX_MPOL=y
- Added: CONFIG_MTK_NET_PHYLIB=m
- Added: CONFIG_NET_CRC32C=y
- Added: CONFIG_PAGE_BLOCK_ORDER=10
- Added: CONFIG_TSM_GUEST=y
- Added: CONFIG_TSM_REPORTS=m

* Thu Jul 24 2025 S.Tindall <s10dal@elrepo.org> - 6.15.8
- Updated with the 6.15.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.15.8]

* Thu Jul 17 2025 S.Tindall <s10dal@elrepo.org> - 6.15.7
- Updated with the 6.15.7 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.15.7]

* Thu Jul 10 2025 S.Tindall <s10dal@elrepo.org> - 6.15.6
...
* Thu May 22 2025 S.Tindall <s10dal@elrepo.org> - 6.14.8
- Updated with the 6.14.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.14.8]

* Sun May 18 2025 S.Tindall <s10dal@elrepo.org> - 6.14.7
...
* Fri Apr 25 2025 S.Tindall <s10dal@elrepo.org> - 6.14.4
...
* Thu Jan 09 2025 S.Tindall <s10dal@elrepo.org> - 6.12.9
- Updated with the 6.12.9 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.12.9]

* Thu Jan 02 2025 S.Tindall <s10dal@elrepo.org> - 6.12.8
...
* Sun Nov 17 2024 S.Tindall <s10dal@elrepo.org> - 6.12.0
- Updated with the 6.12 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.12]
- Removed: CONFIG_ARCH_USES_PG_UNCACHED=y
- Removed: CONFIG_BT_CMTP=m
- Removed: CONFIG_CAPI_TRACE=y
- Removed: CONFIG_DMA_OPS=y
- Removed: CONFIG_HAVE_ZSMALLOC=y
- Removed: CONFIG_I2C_COMPAT=y
- Removed: CONFIG_ISDN_CAPI_MIDDLEWARE=y
- Removed: CONFIG_MODULE_COMPRESS_NONE=y
- Removed: CONFIG_NUMA_EMU=y
- Removed: CONFIG_SND_PCM_ELD=y
- Removed: CONFIG_SND_SOC_HDAC_HDMI=m
- Removed: CONFIG_SND_SOC_INTEL_APL=m
- Removed: CONFIG_SND_SOC_INTEL_BXT_DA7219_MAX98357A_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_BXT_RT298_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_CFL=m
- Removed: CONFIG_SND_SOC_INTEL_CML_H=m
- Removed: CONFIG_SND_SOC_INTEL_CML_LP=m
- Removed: CONFIG_SND_SOC_INTEL_CNL=m
- Removed: CONFIG_SND_SOC_INTEL_DA7219_MAX98357A_GENERIC=m
- Removed: CONFIG_SND_SOC_INTEL_GLK=m
- Removed: CONFIG_SND_SOC_INTEL_KBL_DA7219_MAX98357A_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_KBL_DA7219_MAX98927_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_KBL=m
- Removed: CONFIG_SND_SOC_INTEL_KBL_RT5660_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_KBL_RT5663_MAX98927_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_KBL_RT5663_RT5514_MAX98927_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_SKL=m
- Removed: CONFIG_SND_SOC_INTEL_SKL_NAU88L25_MAX98357A_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_SKL_NAU88L25_SSM4567_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_SKL_RT286_MACH=m
- Removed: CONFIG_SND_SOC_INTEL_SKYLAKE_COMMON=m
- Removed: CONFIG_SND_SOC_INTEL_SKYLAKE_FAMILY=m
- Removed: CONFIG_SND_SOC_INTEL_SKYLAKE_HDAUDIO_CODEC=y
- Removed: CONFIG_SND_SOC_INTEL_SKYLAKE=m
- Removed: CONFIG_SND_SOC_INTEL_SKYLAKE_SSP_CLK=m
- Removed: CONFIG_SND_SOC_INTEL_SST=m
- Removed: CONFIG_SND_SOC_RT5514=m
- Removed: CONFIG_SND_SOC_RT5514_SPI=m
- Removed: CONFIG_SND_SOC_RT5663=m
- Removed: CONFIG_SPLIT_PTLOCK_CPUS=4
- Removed: CONFIG_TOUCHSCREEN_CYTTSP4_CORE=m
- Removed: CONFIG_TOUCHSCREEN_CYTTSP4_I2C=m
- Removed: CONFIG_TOUCHSCREEN_CYTTSP4_SPI=m
- Removed: CONFIG_TOUCHSCREEN_MCS5000=m
- Added: CONFIG_AMD_ATL_PRM=y
- Added: CONFIG_ARCH_DEFAULT_CRASH_DUMP=y
- Added: CONFIG_ARCH_HAS_DMA_OPS=y
- Added: CONFIG_ARCH_HAVE_EXTRA_ELF_NOTES=y
- Added: CONFIG_ARCH_PKEY_BITS=4
- Added: CONFIG_ARCH_SUPPORTS_HUGE_PFNMAP=y
- Added: CONFIG_ARCH_SUPPORTS_PMD_PFNMAP=y
- Added: CONFIG_ARCH_SUPPORTS_PUD_PFNMAP=y
- Added: CONFIG_ARCH_SUPPORTS_RT=y
- Added: CONFIG_ARCH_USES_PG_ARCH_2=y
- Added: CONFIG_DMA_OPS_HELPERS=y
- Added: CONFIG_EROFS_FS_BACKED_BY_FILE=y
- Added: CONFIG_GROUP_SCHED_WEIGHT=y
- Added: CONFIG_HUGETLB_PMD_PAGE_TABLE_SHARING=y
- Added: CONFIG_KVM_X86=m
- Added: CONFIG_MITIGATION_GDS=y
- Added: CONFIG_MITIGATION_L1TF=y
- Added: CONFIG_MITIGATION_MDS=y
- Added: CONFIG_MITIGATION_MMIO_STALE_DATA=y
- Added: CONFIG_MITIGATION_RETBLEED=y
- Added: CONFIG_MITIGATION_SPECTRE_V1=y
- Added: CONFIG_MITIGATION_SPECTRE_V2=y
- Added: CONFIG_MITIGATION_SRBDS=y
- Added: CONFIG_MITIGATION_SSB=y
- Added: CONFIG_MITIGATION_TAA=y
- Added: CONFIG_MLX5_HW_STEERING=y
- Added: CONFIG_NET_DEVMEM=y
- Added: CONFIG_NUMA_EMU=y
- Added: CONFIG_NUMA_MEMBLKS=y
- Added: CONFIG_RUSTC_LLVM_VERSION=0
- Added: CONFIG_RUSTC_VERSION=0
- Added: CONFIG_SND_SOC_ACPI_AMD_MATCH=m
- Added: CONFIG_SND_SOC_SOF_INTEL_PTL=m
- Added: CONFIG_SND_SOC_SOF_PANTHERLAKE=m
- Added: CONFIG_SPLIT_PMD_PTLOCKS=y
- Added: CONFIG_SPLIT_PTE_PTLOCKS=y
- Added: CONFIG_XZ_DEC_ARM64=y
- Added: CONFIG_XZ_DEC_RISCV=y
- Added: CONFIG_ZRAM_BACKEND_FORCE_LZO=y
- Added: CONFIG_ZRAM_BACKEND_LZO=y

* Sun Nov 17 2024 S.Tindall <s10dal@elrepo.org> - 6.11.9
- Updated with the 6.11.9 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.11.9]

* Thu Nov 14 2024 S.Tindall <s10dal@elrepo.org> - 6.11.8
- Updated with the 6.11.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.11.8]

* Fri Nov 08 2024 S.Tindall <s10dal@elrepo.org> - 6.11.7
- Updated with the 6.11.7 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.11.7]

* Thu Oct 31 2024 S.Tindall <s10dal@elrepo.org> - 6.11.6
- Updated with the 6.11.6 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.11.6]
- Added: CONFIG_IDPF=m

* Tue Oct 22 2024 Akemi Yagi <toracat@elrepo.org> - 6.11.5
- Updated with the 6.11.5 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.11.5]
- Added: CONFIG_LEGACY_PTYS=y
- Added: CONFIG_LEGACY_PTY_COUNT=256
...
* Fri Oct 04 2024 S.Tindall <s10dal@elrepo.org> - 6.11.2
- Updated with the 6.11.2 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.11.2]

* Mon Sep 30 2024 S.Tindall <s10dal@elrepo.org> - 6.11.1
- Updated with the 6.11.1 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.11.1]
- Added: CONFIG_GPIO_LJCA=m
- Added: CONFIG_I2C_LJCA=m
- Added: CONFIG_MEDIA_PCI_SUPPORT=y
- Added: CONFIG_MEDIA_PLATFORM_DRIVERS=y
- Added: CONFIG_SPI_LJCA=m
- Added: CONFIG_USB_LJCA=m
- Added: CONFIG_VIDEOBUF2_DMA_CONTIG=m
- Added: CONFIG_VIDEO_HI556=m
- Added: CONFIG_VIDEO_INTEL_IPU6=m
- Added: CONFIG_VIDEO_OV01A10=m
...
* Sat Mar 02 2024 S.Tindall <s10dal@elrepo.org> - 6.7.8-1
...
- Updated with the 6.7.7 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.7.7]

* Fri Feb 23 2024 S.Tindall <s10dal@elrepo.org> - 6.7.6-1
- Updated with the 6.7.6 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.7.6]
- Added: CONFIG_NFS_V2=m

* Fri Feb 16 2024 S.Tindall <s10dal@elrepo.org> - 6.7.5-1
- Updated with the 6.7.5 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.7.5]

* Mon Feb 05 2024 S.Tindall <s10dal@elrepo.org> - 6.7.4-1
